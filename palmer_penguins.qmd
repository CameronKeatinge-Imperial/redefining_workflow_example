---
title: "Palmer Penguins write up"
...
This Rmarkdown document is my first Quarto file, analysing the palmer penguins dataset [@casella2024statistical]

# Difference of weights between different species
...
This is the code which produces the following graph
```{r}
